...
import com.vcet.campushire.security.JwtAuthFilter;
        ...
        http
                ...
                .exceptionHandling(eh -> eh
                        ...
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            ...
                            response.setContentType("application/json");
                            response.getWriter().write("{\"status\":403,\"error\":\"Forbidden\",\"message\":\"" + accessDeniedException.getMessage() + "\",\"path\":\"" + request.getRequestURI() + "\"}");
                        })
                )
