            ...
            <div className="hidden md:flex items-center gap-4 flex-1 max-w-2xl mx-8">
              <form onSubmit={handleSearch} className="relative flex-1">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-colors ${
                    darkMode 
            ...
            <div className="relative">
              ...
              {showNotifications && (
                <>
                  ...
                  />
                  <div className={`absolute right-0 mt-2 w-96 rounded-xl shadow-xl z-50 ${
                    darkMode 
                          ...
                          >
                            <div className="flex items-start gap-3">
                              <div className={`p-2 rounded-lg ${
                                notification.type === 'drive' ? (darkMode ? 'bg-blue-900/30 text-blue-400' : 'bg-blue-100 text-blue-600') :
